...
try: 
    ...
    input1.send_keys("Erdem")
    input2 = browser.find_element_by_class_name("second")
    input2.send_keys("M")
    input3 = browser.find_element_by_class_name("third")
    input3.send_keys("erd@gmail.com")

    #input4 = browser.find_elements_by_tag_name("[placeholder='phone:']")
    input4 = browser.find_element_by_xpath('//input[@placeholder="Input your phone:"]')
    input4.send_keys("89885634115")

    #input5 = browser.find_elements_by_tag_name("[placeholder='address:']")
